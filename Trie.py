...
class _TrieNode(object):
    ...
    def __init__(self):
        ...
        '''This init method initializes three global variables
            a list called __body
            a dictionary called __children
            a list called __values'''
    ...
    def insert(self, data, value):
        ...
        if (not self.__body):
            print 'root empty. Added', data, 'and', value
            self._set_body(data)
